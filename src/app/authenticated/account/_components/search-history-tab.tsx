    ...
    <Card className="mt-6 border-0 shadow-none">
      <CardHeader>
        ...
        <CardDescription>
          ...
          <Link href="/authenticated/search/history" className="underline text-primary hover:text-primary/80">
      ...
      <CardFooter className="border-t pt-6">
        <Button asChild>
            <Link href="/authenticated/search/history">{t('account.searchHistory.viewAllButton')}</Link>
        </Button>
      </CardFooter>
    </Card>
  );
