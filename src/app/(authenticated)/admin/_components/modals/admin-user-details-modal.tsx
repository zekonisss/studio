      ...
      <DialogContent className="sm:max-w-[600px]">
        ...
        <ScrollArea className="max-h-[60vh] pr-4">
            <div className="py-4 space-y-2">
                ...
                <DetailRow label="Registracijos data" value={new Date(user.registeredAt).toLocaleString(locale)} />
                <DetailRow label="Aktyvacijos data" value={user.accountActivatedAt ? new Date(user.accountActivatedAt).toLocaleString(locale) : '-'} />
            </div>
        </ScrollArea>
        <DialogFooter>
