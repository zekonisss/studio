...
export default function SearchPage() {
    ...
    return (
        <div className="-m-4 min-h-full p-4 md:-m-8 md:p-8 dark:bg-gradient-to-b dark:from-[#0B1220] dark:to-[#111827]">
            <div className="space-y-6">
                <Card className="dark:bg-white/5 dark:border-white/10 dark:backdrop-blur-sm">
                    <CardHeader>
                        ...
                        <div>
                            {isLoading && (
                                <div className="space-y-4">
                                    {[...Array(3)].map((_, i) => (
                                        <Card key={i} className="dark:bg-white/5 dark:border-white/10">
                                            <CardHeader>
                                ...
                                <div className="space-y-4">
                                    ...
                                    {searchResults.map((report) => (
                                        <Card key={report.id} className={cn(
                                            "overflow-hidden transition-shadow duration-300 dark:bg-white/5 dark:border-white/10",
